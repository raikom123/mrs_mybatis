...
class ReservationServiceImplTests {
    ...
    assertThrows(
        ...
        () -> {
          ReservationServiceImpl reservationServiceImpl =
              new ReservationServiceImpl(null, null, reservationsMapper);
  ...
  void reserve_登録済のデータと重複している場合Exceptionがthrowされること() {
    ...
    // モック作成
    var reservationsMapper = mock(ReservationsMapper.class);
    when(reservationsMapper.selectReservableRoomForUpdate(any(), any()))
        .thenReturn(reservableRoomKey(reservation));
    ...
    assertThrows(
        ...
        () -> {
          var reservationServiceImpl =
              new ReservationServiceImpl(reservationMapper, null, reservationsMapper);
  ...
  void reserve_登録できた場合saveの戻り値が返却されること() {
    ...
    var reservationsMapper = mock(ReservationsMapper.class);
    when(reservationsMapper.selectReservableRoomForUpdate(any(), any()))
        .thenReturn(reservableRoomKey(actual));
    var reservationMapper = mock(ReservationMapper.class);
