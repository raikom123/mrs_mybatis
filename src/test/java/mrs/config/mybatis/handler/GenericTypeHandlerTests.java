...
class GenericTypeHandlerTests {
	...
	@Test
	void getNullableResultResultSetString_引数のMybatisMappedValueのgetValueの結果が返却されること() throws SQLException {
	...
	@Test
	void getNullableResultResultSetInt_引数のMybatisMappedValueのgetValueの結果が返却されること() throws SQLException {
		SuccessType actual = SuccessType.B;
		int columnIndex = 1;
	...
	@Test
	void getNullableResultCallableStatementInt_引数のMybatisMappedValueのgetValueの結果が返却されること() throws SQLException {
		SuccessType actual = SuccessType.B;
		int columnIndex = 1;
